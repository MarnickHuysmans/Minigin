...
void qbert::QbertDeleteThis::Start()
{
}

void qbert::QbertDeleteThis::Update()
{
	if (m_ControlsrSet)
	{
...
int qbert::QbertDeleteThis::GetLives() const
{
	return m_Lives;
}

void qbert::QbertDeleteThis::AddObserver(dae::Observer* observer)
{
	m_Subject.AddObserver(observer);
}

void qbert::QbertDeleteThis::RemoveObserver(dae::Observer* observer)
{
	m_Subject.RemoveObserver(observer);
}

void qbert::QbertDeleteThis::SetButtons(dae::ControllerButton button1, dae::ControllerButton button2, dae::ControllerButton button3, dae::ControllerButton button4, dae::ControllerButton button5)
{
	m_ControlsrSet = true;
...
void qbert::QbertDeleteThis::SetButtons(dae::KeyboardCode button1, dae::KeyboardCode button2, dae::KeyboardCode button3, dae::KeyboardCode button4, dae::KeyboardCode button5)
{
	m_ControlsrSet = true;
...
void qbert::QbertDeleteThis::Die()
{
	if (m_Lives > 0)
	{
		--m_Lives;
