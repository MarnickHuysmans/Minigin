...
const std::weak_ptr<qbert::Qbert> qbert::QbertFactory::CreateQbert(dae::Scene& scene, const std::weak_ptr<Walkable>& startCube, dae::Player player, const std::shared_ptr<dae::Font>& font)
{
